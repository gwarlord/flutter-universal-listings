...
exports.maintainSearchIndexListings = void 0;
const functions = __importStar(require("firebase-functions/v1"));
const admin = __importStar(require("firebase-admin"));
const db = admin.firestore();
exports.maintainSearchIndexListings = functions.firestore
...
function shouldRemoveFromIndex(listing) {
...
function extractServicesText(services) {
...
function extractMenuText(menuSections) {
...
function extractFiltersText(filters) {
...
function buildIndexDocument(listingId, listing) {
    ...
    return {
        ...
        freshnessStatus: listing.freshness?.status || "",
