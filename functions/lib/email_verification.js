...
exports.cleanupExpiredCodes = exports.verifyEmailCode = exports.sendPasswordResetEmailButton = exports.sendVerificationCode = void 0;
...
exports.sendVerificationCode = functions.runWith({ secrets: [secrets_1.sendgridKeySecret] }).https.onCall(async (data, context) => {
...
exports.sendPasswordResetEmailButton = functions.runWith({ secrets: [secrets_1.sendgridKeySecret] }).https.onCall(async (data) => {
    ...
    try {
        ...
        await mail_1.default.send({
            ...
            text: `We received a request to reset your CaribTap password.\n\n` +
