...
/// Usage: Import this in a temporary button or run via a test
class TestDataPopulator {
  ...
  static const List<String> listingImages = [
    ...
    'https://images.unsplash.com/photo-1521791136064-7986c2959213?w=500',
  ...
  static Future<void> _createChats(List<String> userIds, List<String> listingIds) async {
    // Create a few conversation threads
    for (int i = 0; i < 5; i++) {
  ...
  static Future<void> purgeTestData() async {
    ...
    for (var coll in collections) {
      ...
      for (var doc in snap.docs) {
        if (doc.id.startsWith('test_') || doc.data().toString().contains('Test')) {
