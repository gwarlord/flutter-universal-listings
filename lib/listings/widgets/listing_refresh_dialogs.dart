      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Please verify your listing information is current'.tr(),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Optional: Verifying helps keep your listing accurate'.tr(),
                        style: const TextStyle(fontSize: 13),
                      ),
                    ),
                  ],
            ...
            const SizedBox(height: 16),
            Text(
              'Verify the following information:'.tr(),
              style: const TextStyle(
                fontSize: 14,
            ...
            if (!widget.requireVerification && !allVerified)
              Text(
                'You can refresh without verification, but we recommend checking these items.'.tr(),
                style: TextStyle(
                  fontSize: 12,
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: _refreshing
              ...
              : Text(allVerified ? 'Verified & Refresh'.tr() : 'Refresh'.tr()),
        ),
      ],
    );
  }
          ...
          content: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  verified
                      ? 'Listing refreshed and verified successfully!'.tr()
                      : 'Listing refreshed successfully!'.tr(),
                ),
              ),
            ],
          ),
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(child: Text('Error: {}'.tr(args: [e.toString()]))),
            ],
          ),
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          if (daysRemaining > 0) ...[
            Text('Current freshness: {} days remaining'.tr(args: ['$daysRemaining'])),
            const SizedBox(height: 8),
          ],
          Text(
            'This will reset your listing freshness to {} days.'.tr(args: ['${freshness?.days ?? 90}']),
...
class _BulkRefreshDialogState extends State<BulkRefreshDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text('Refresh {} Listings?'.tr(args: ['${widget.listings.length}'])),
      content: Column(
        mainAxisSize: MainAxisSize.min,
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            'This will refresh freshness for {} listings:'.tr(args: ['${widget.listings.length}']),
          ...
          if (widget.showVerification) ...[
            ...
            CheckboxListTile(
              ...
              title: Text(
                'I confirm all listing information is current'.tr(),
                style: const TextStyle(fontSize: 13),
              ),
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  '{} listings refreshed successfully!'.tr(args: ['${widget.listings.length}']),
                ),
              ),
            ],
          ),
