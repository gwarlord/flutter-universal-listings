  ...
  InputDecoration _inputDecoration(BuildContext context, String hint, {IconData? icon}) {
    ...
    return InputDecoration(
      ...
      border: OutlineInputBorder(
        ...
        borderSide: BorderSide(color: dark ? Colors.grey.shade800 : Colors.grey.shade300),
      ),
            ...
            child: SafeArea(
              child: GestureDetector(
                ...
                child: BlocBuilder<LoginBloc, LoginState>(
                  buildWhen: (old, current) => current is LoginFailureState && old != current,
                        ...
                        children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  TextFormField(
                                    ...
                                    style: TextStyle(
                                      fontSize: 18.0,
                                      color: isDarkMode(context) ? Colors.white : Colors.grey.shade900,
                                    ),
                                    keyboardType: TextInputType.emailAddress,
                                    cursorColor: Color(colorPrimary),
                                    decoration: _inputDecoration(context, 'Email Address'.tr(), icon: Icons.email_outlined),
                                  ),
                                  ...
                                  TextFormField(
                                    ...
                                    cursorColor: Color(colorPrimary),
                                    decoration: _inputDecoration(context, 'Password'.tr(), icon: Icons.lock_outline).copyWith(
                                  ...
                                  Align(
                                    ...
                                    child: TextButton(
                                      onPressed: () => push(context, const ResetPasswordScreen()),
                                      child: const Text(
                                        'Forgot password?',
                          ...
                          ElevatedButton.icon(
                            ...
                            onPressed: () {
                              context.read<LoadingCubit>().showLoading(
                                    context,
                                    'Signing in with Google, Please wait...'.tr(),
                                    false,
                                    Color(colorPrimary),
                                  );
                          ...
                          InkWell(
                            onTap: () {
                              pushReplacement(context, const PhoneNumberInputScreen(isLogin: true));
                            },
                            child: Padding(
